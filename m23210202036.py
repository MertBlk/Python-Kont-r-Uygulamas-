...
def gorusme_yap(kontor_miktari, gorusme_suresi):
...
def gorusme_bilgisi(gorusme_suresi):
    print(f"{gorusme_suresi} dakika görüşme yaptınız.")


kontor_miktari = 0.0
son_gorusme_suresi = 0
...
while True:
    ...
    if secim == "1":
        ...
        try:
            ...
            kontor_miktari = gorusme_yap(kontor_miktari, gorusme_suresi)
            son_gorusme_suresi = gorusme_suresi
        except ValueError:
            print("Geçersiz değer girildi, lütfen tekrar deneyin.")
    elif secim == "3":
        while True:
            ...
            if menu_secim == "1":
                ...
                gorusme_bilgisi(son_gorusme_suresi)
            elif menu_secim == "9":
                break
            else:
